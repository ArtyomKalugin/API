...
class Gamer():
    ...
    def make_choice(self, value=None, suit=None, num=None):
        if value:
            if len(self.player_cards.keys()) == 0 and len(self.second_gamer_cards.keys()) == 0:
                self.first_time = True
                self.my_card_now = random.chocie(self.my_cards)
...
print(a.show_cards())
print()
a.change_enemy_cards(2, value=('6', True))
print(a.show_player_cards())
print(a.show_second_cards())
print()
a.change_enemy_cards(2, num=('2', True))
print(a.show_player_cards())
print(a.show_second_cards())
print()
a.change_enemy_cards(2, suit=('т п', True))
print(a.show_player_cards())
print(a.show_second_cards())
print()
